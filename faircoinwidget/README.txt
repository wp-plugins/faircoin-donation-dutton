...
You can also use the wizard on http://getfaircoin.net/widget/ to generate linking codes, if you wanna host the script and use it, be sure to change: 
<script src="http://getfaircoin.net/widget/widget/coin.js"></script> to use your own hosted copy of coin.js.
